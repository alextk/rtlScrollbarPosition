...
JS_FILES = license.txt\
	${SRC_DIR}/jquery.rtl-scrollbar-position.js

JS = ${DIST_DIR}/jquery.rtl-scrollbar-position.js
JS_MIN = ${DIST_DIR}/jquery.rtl-scrollbar-position.min.js
JS_PACK = ${DIST_DIR}/jquery.rtl-scrollbar-position.pack.js
